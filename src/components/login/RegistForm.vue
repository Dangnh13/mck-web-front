        ...
        <v-row>
            <v-col cols="12" md="6" class="blue rounded-br-xl">
                <div style="  text-align: center; padding: 180px 0;">
                    <v-card-text class="white--text">
                        ...
                        <h6 class="text-center">Log in to your account so you can
                            continue building and<br> editing your onboarding flows</h6>
                    </v-card-text>
                    <div class="text-center">
                        <v-btn tile outlined dark @click="OPEN_LOGIN_WINDOW('LOGIN')">Log in
                        </v-btn>
                    </div>
                </div>
            </v-col>
            ...
            <v-col cols="12" md="6">
                <v-card-text class="mt-12">
                    ...
                    <h6 class="text-center  grey--text ">Let's get you all set up so you
                        can start creatin your <br>
